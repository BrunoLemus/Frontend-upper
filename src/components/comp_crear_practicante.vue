...
export default {
  ...
  setup() {
    ...
    const cargarPracticantes = async () => {
      try {
        const res = await axios.get("https://backend-upper.onrender.com/user_practicantes/", { headers });
    ...
    const crearPracticante = async () => {
      try {
        ...
        await axios.post("https://backend-upper.onrender.com/user_practicantes/", payload, { headers });
    ...
    const editarPracticante = async (p) => {
      try {
        ...
        await axios.put(`https://backend-upper.onrender.com/user_practicantes/${p.id}`, cambios, { headers });
    ...
    const eliminarPracticante = async (id) => {
      ...
      try {
        await axios.delete(`https://backend-upper.onrender.com/user_practicantes/${id}`, { headers });
