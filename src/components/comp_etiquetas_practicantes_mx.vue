  ...
  methods: {
    ...
    async cargarDatosPracticante() {
      try {
        ...
        const response = await axios.get("https://backend-upper.onrender.com/user_practicantes_mx/me", {
    ...
    async saveUser() {
      try {
        ...
        await axios.put(
          `https://backend-upper.onrender.com/user_practicantes_mx/${this.practicanteId}`,
          {
    ...
    async guardarDatosPracticante() {
      ...
      try {
        const response = await axios.post(
          "https://backend-upper.onrender.com/cajas_mx/?sede=mexico&role=practicante",
          payload,
          {
            headers: {
              "accept": "application/json",
    ...
    async getUserInfo() {
      try {
        const token = localStorage.getItem("token");
        // LIMPIO: Espacios irregulares eliminados
        const response = await axios.get("https://backend-upper.onrender.com/user_practicantes_mx/me", { headers: { Authorization: `Bearer ${token}` } });
        if (response.data) {
