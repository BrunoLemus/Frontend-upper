  ...
  methods: {
    ...
    async fetchHistorial() {
      try {
        ...
        const response = await axios.get("https://backend-upper.onrender.com/historial/", {
    ...
    async guardarEdicion() {
      ...
      const url =
        tipo === "Caja"
          ? `https://backend-upper.onrender.com/historial/caja/${this.registroEditando.id}`
          : `https://backend-upper.onrender.com/historial/tarima/${this.registroEditando.id}`;
      try {
        const token = localStorage.getItem("token");
      ...
      try {
        ...
        const url =
          registro.tipo_pedido === "Caja"
            ? `https://backend-upper.onrender.com/historial/caja/${registro.id}`
            : `https://backend-upper.onrender.com/historial/tarima/${registro.id}`;
